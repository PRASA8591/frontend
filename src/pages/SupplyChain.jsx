...
const SupplyChain = () => {
  ...
  const loadCoreData = async () => {
    ...
    try {
      const [posRes, grnRes, itemsRes, returnsRes, suppliersRes] = await Promise.all([
        axios.get('http://127.0.0.1:5000/api/supply/po', config),
        axios.get('http://127.0.0.1:5000/api/supply/grn', config),
        axios.get('http://127.0.0.1:5000/api/inventory', config),
        axios.get('http://127.0.0.1:5000/api/supply/returns', config),
        axios.get('http://127.0.0.1:5000/api/customers?type=Supplier', config)
      ]);
  ...
  const handleCreatePO = async (statusType = 'pending_approval') => {
    ...
    try {
      if (editingPoId) {
        await axios.put(`http://127.0.0.1:5000/api/supply/po/${editingPoId}`, {
          supplier: poSupplier, items: poItemsWorkspace, notes: poNotes, status: statusType
        }, config);
      } else {
        await axios.post('http://127.0.0.1:5000/api/supply/po', {
          supplier: poSupplier, items: poItemsWorkspace, notes: poNotes, status: statusType
        }, config);
      }
  ...
  const handleApprovePO = async (id) => {
    ...
    try {
      await axios.post(`http://127.0.0.1:5000/api/supply/po/${id}/approve`, {}, config);
  ...
  const handleCompletePO = async (id) => {
    try {
      await axios.put(`http://127.0.0.1:5000/api/supply/po/${id}/status`, { status: 'pending_approval' }, config);
  ...
  const handleCompleteGRN = async (id) => {
    try {
      await axios.post(`http://127.0.0.1:5000/api/supply/grn/${id}/approve`, {}, config);
  ...
  const handleCompleteReturn = async (id) => {
    try {
      await axios.post(`http://127.0.0.1:5000/api/supply/returns/${id}/complete`, {}, config);
  ...
  const handleCreateGRN = async (statusType = 'approved') => {
    ...
    try {
      await axios.post('http://127.0.0.1:5000/api/supply/grn', {
  ...
  const handleCreateReturn = async (statusType = 'completed') => {
    ...
    try {
      await axios.post('http://127.0.0.1:5000/api/supply/returns', {
